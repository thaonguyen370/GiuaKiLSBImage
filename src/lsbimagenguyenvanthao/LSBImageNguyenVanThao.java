...
import static lsbimagenguyenvanthao.LSBImageNguyenVanThao.workingDir;


public class LSBImageNguyenVanThao {
    public static String workingDir;
public static void main(String [] args) throws Exception{
   
             workingDir = System.getProperty("user.dir");		
		FileReader code = new FileReader(workingDir+"\\src\\DuLieu\\input.txt");
...
class ImageProcess{
	BufferedImage fetchImage() throws Exception{
		File f = new File(workingDir+"\\src\\DuLieu\\dauvao.png");
	...
	void createImgWithMsg(BufferedImage img){
		try{
			File ouptut = new File(workingDir+"\\src\\DuLieu\\out.png");
	...
	BufferedImage newImageFetch(){
		File f = new File(workingDir+"\\src\\DuLieu\\out.png");
